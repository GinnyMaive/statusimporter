...
def authorize():
    ...
    if creds:
        ...
        print('Credentials saved:', token_data)
        creds = load_credentials()
    return creds
...
def process_note(creds, note):
    ...
    # TODO: check if this post has already been posted (it's in our post mapping file) and skip if so
    # TODO: check the replyId and get the new ID for the reply or skip if we can't do that
    print('-----')
